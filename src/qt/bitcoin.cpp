...
static void handleRunawayException(std::exception *e) {
    ...
    QMessageBox::critical(0, "Runaway exception", BitcoinGUI::tr("A fatal error occurred. Spark can no longer continue safely and will quit.") + QString("\n\n") + QString::fromStdString(strMiscWarning));
    exit(1);
}
...
int main(int argc, char *argv[]) {
    ...
    if (GetBoolArg("-testnet")) { // Separate UI settings for testnet
        app.setApplicationName("Spark-Qt-testnet");
    } else {
        app.setApplicationName("Spark-Qt");
    }
