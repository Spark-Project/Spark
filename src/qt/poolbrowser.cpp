...
//Coinbase API
const QString apiCoinbasePrice = "http://api.getsparkcoin.com/coinbase/exchange_rates.php";

//Bittrex API
const QString apiBittrexMarketSummary = "http://api.getsparkcoin.com/bittrex/market.php";
const QString apiBittrexTrades = "http://api.getsparkcoin.com/bittrex/trades.php";
const QString apiBittrexOrders = "http://api.getsparkcoin.com/bittrex/orders.php";

//Mintpal API
const QString apiMintpalMarketSummary = "http://api.getsparkcoin.com/mintpal/market.php";
const QString apiMintpalTrades = "http://api.getsparkcoin.com/mintpal/trades.php";
const QString apiMintpalOrdersSell = "http://api.getsparkcoin.com/mintpal/orders_sell.php";
const QString apiMintpalOrdersBuy = "http://api.getsparkcoin.com/mintpal/orders_buy.php";

//Poloniex API
const QString apiPoloniexMarketSummary = "http://api.getsparkcoin.com/poloniex/market.php";
const QString apiPoloniex24hVolume = "http://api.getsparkcoin.com/poloniex/chartdata.php";
const QString apiPoloniexTrades = "http://api.getsparkcoin.com/poloniex/trades.php";
const QString apiPoloniexOrders = "http://api.getsparkcoin.com/poloniex/orders.php";

//Cryptsy API
const QString apiCryptsyTrades = "http://api.getsparkcoin.com/cryptsy/trades.php";
const QString apiCryptsyOrders = "http://api.getsparkcoin.com/cryptsy/orders.php";
...
void PoolBrowser::on_btnConvertSilkoin_clicked() {
    double SparkQty = ui->txtConvertSparkQty->text().toDouble();
    double totalBtc = _bittrexMarketSummary->getLastCurrent(double()) * SparkQty;
    double totalUsd = totalBtc * _dBtcPriceCurrent;

    ui->lblConvertSparkResults->setText("$" + QString::number(totalUsd, 'f', 2) +
...
void PoolBrowser::cryptsyOrders(QNetworkReply* response) {
    try {
        ...
        apiResponse = apiResponse.replace("{\"success\":1,\"return\":{\"SPARK\":{\"marketid\":\"225\",\"label\":\"SPARK\\/BTC\",\"primaryname\":\"Spark\",\"primarycode\":\"SPARK\",\"secondaryname\":\"BitCoin\",\"secondarycode\":\"BTC\",\"sellorders\":[", "");
